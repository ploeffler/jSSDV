...
import org.prowl.aprslib.utils.Utilities;
...
public class CourseAndSpeedExtension extends DataExtension implements Serializable {
   ...
   /**
    * @param course
    *           the course to set in degrees true
    */
   ...
   /**
    * @return the current speed in knots and course in degrees in a formatted string
    */
   @Override
